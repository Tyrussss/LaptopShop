                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">                               
                                 <i style="color:green" class="far fa-edit"></i> Edit Category</div>
                                ...
                                <table>    
                                    <tbody>                                 
                                        <tr>
                                            ...
                                            <td style="padding:0 20px 20px 0"><input type="text" name="categoryID" value="${category.catID}" placeholder="ID Auto" readonly="true" class="form-control"/></td>                                           
                                            
                                        </tr>     
                                        <tr>
                                            <td style="padding:0 20px 20px 0">Category Name</td>
                                            <td style="padding:0 20px 20px 0"><input type="text" name="categoryName" value="${category.catName}" placeholder="Category Name" class="form-control"/></td>                                     
                                        </tr> 

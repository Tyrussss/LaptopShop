                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">                                
                                 <i style="color:green" class="fas fa-folder-plus"></i> AddNew Course </div>
                            ...
                            <div class="card-body">
                                ...
                                <table>    
                                    <tbody>  
                                         <tr>
                                            ...
                                            <td style="padding:0 20px 20px 0">
                                             <select name="catID"  style="width:100%" class="dataTable-selector B_select" id="catID" onchange="Sendata();">                                          
                                             <c:forEach var="categoryItem" items="${listCategory}">
                                                    <option value="${categoryItem.catID}" ${catID==categoryItem.catID?"selected='selected'":""} >${categoryItem.catName}</option>                                                 
                                            </c:forEach>
                                             </select>   
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:0 20px 20px 0"><input type="text" name="courseID" placeholder="ID Auto" readonly="true" class="form-control"/></td>                                           
                                            
                                        </tr>     
                                        <tr>
                                            <td style="padding:0 20px 20px 0">Course Name</td>
                                            <td style="padding:0 20px 20px 0"><input type="text" name="courseName" placeholder="Course Name" class="form-control"/></td>                                     
                                        </tr> 
                                    ...
                                    <p></p>
                            <a style="text-decoration: none;" href="${pageContext.request.contextPath}/AdminCourse?action=0&catID=${param.catID}">&#60;&#60;<span style="text-decoration: underline;"> Back to Course<span></a>
                            </div>
                        </div>
                    </div>
                </main>

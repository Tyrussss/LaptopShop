<%-- 
    ...
    Created on : 17 Sept 2021, 11:54:32
    Author     : nguye
--%>
...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>My Learning_Leson Detail</title>
	...
	<!-- All PLUGINS CSS ============================================= -->
        ...
        <link rel="stylesheet" type="text/css" href="assets/css/thanhbinhstyle.css"><!-- comment -->
		...
		<div class="content-block">
			...
			<div class="section-area section-sp1">
                <div class="container">
                     ...
                     String teacherAvatar=request.getParameter("teacherAvatar");
                     String teacherName=request.getParameter("teacherName");
                     String price=request.getParameter("price");
                     String priceSalesoff=request.getParameter("priceSalesoff");
                     String picturecard=request.getParameter("picturecard");
						...
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							<div class="course-detail-bx">
								<div class="course-price">
									...
									<h4 class="price"><%=priceSalesoff%><sup>đ</sup></h4>
								</div>	
								<div class="course-buy-now text-center alignBinh">
                                                                    <a href="AddCartServlet?lectureID=<%=lectureID%>&priceSalesoff=<%=priceSalesoff%>" class="btn radius-xl text-uppercase btnBinh"> <image <script src="assets/images/shopping-cart.png"> Add to Cart</a>
								</div>
								<div class="teacher-bx">
									<div class="teacher-info">
										<div class="teacher-thumb">
											<img src="assets/images/teacher/<%=teacherAvatar%>" alt=""/>
										</div>
						...
						<div class="col-lg-9 col-md-8 col-sm-12">
							<div class="courses-post">
								<div class="ttr-post-media media-effect">
									<a href="#"><img src="assets/images/lesson/<%=picturecard%>" alt=""></a>
								</div>
								<div class="ttr-post-info">
									<div class="ttr-post-title ">
                                                                       
										<h2 class="post-title"><%=lesson%></h2>
									</div>

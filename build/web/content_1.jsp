                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                        ...
                        <!--                                    <div class="widget widget_archive">
                                                                <h5 class="widget-title style-1">BestSeller Course</h5>
                                                                <ul>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-sm-6 m-b30 cards">
                                <div class="cours-bx ">
                                    ...
                                    <div class="info-bx text-center">
                                        <h5><a href="#"><%=itemLecture.getName()%></a></h5>
                                        <span>Programming</span>
                                        
                                        <div class="cours-more-info cardBinh-bottom">
                                        <div class="review">
                                            <span>3 Review</span>
                                            <ul class="cours-star">
...
<!--                            <div class="col-md-6 col-lg-4 col-sm-6 m-b30">
                                <div class="cours-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Java2-JSP & Servlet</a></h5>
                                        <span>Programming</span>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-sm-6 m-b30">
                                <div class="cours-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Google-Ads & SEO Master</a></h5>
                                        <span>Marketing</span>
                                    </div>
                                    <div class="cours-more-info">
                                        <div class="review">
...
<!--                            <div class="col-md-6 col-lg-4 col-sm-6 m-b30">
                            ...
                            <div class="col-md-6 col-lg-4 col-sm-6 m-b30">
                                <div class="cours-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        <h5><a href="#">English Conversation for Business</a></h5>

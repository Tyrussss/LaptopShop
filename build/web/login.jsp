<%-- 
    Document   : login
    Created on : 17 Sept 2021, 16:51:48
    Author     : nguye
--%>
...
<div class="page-wraper">
	...
	<div class="account-form">
		<div class="account-head">
                     <!--style="background-image:url(assets/images/background/logincourse.png);"-->
			<a href="index.jsp"><img src="assets/images/background/logincourse.png" alt=""></a>
		</div>
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
                                     <!--<div class="loghome"><a href="index.jsp">Home</a></div>-->
					...
					<p>Don't have an account? <a href="register.jsp">Create one here</a></p>
                            ...
                            <form class="contact-bx" action="LoginServlet" method="post" onsubmit="return CheckDataLogin()">
					<div class="row placeani">
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									<!--<label>Username</label>-->
                                                                        <input  placeholder="Username" name="Username" type="text" id="Username" value="${param.Username}" class="form-control">
								</div>
							</div>
						</div>
						<div class="col-lg-12">
